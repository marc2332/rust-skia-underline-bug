use skia_safe::{
    ...
    Canvas, Color, FontMgr, FontStyle,
};
...
fn main() {
    ...
    font_collection.set_default_font_manager(font_mgr, "Inter");
    ...
    impl ApplicationHandler for Application {
        ...
        fn window_event(
            ...
            if draw_frame {
                ...
                render(canvas, &self.env.font_collection, 20., "hello");
                render(canvas, &self.env.font_collection, 70., "Hello, World");
                render(canvas, &self.env.font_collection, 120., "value");
                render(canvas, &self.env.font_collection, 170., "1234");
                render(canvas, &self.env.font_collection, 220., "AbCdEf");
                render(canvas, &self.env.font_collection, 270., "aaaaaaaa, hey");
                render(canvas, &self.env.font_collection, 320., "??? ! 123");
                render(canvas, &self.env.font_collection, 370., ",");
...
fn render(canvas: &Canvas, font_collection: &FontCollection, y: f32, text: &str) {
    let mut text_style = TextStyle::new();
    text_style.set_color(Color::RED);
    text_style.set_font_size(20.0);
    text_style.set_font_style(FontStyle::default());
    text_style.set_font_families(&["Inter"]);
    let mut text_decoration = TextDecoration::empty();
    text_decoration.set(TextDecoration::UNDERLINE, true);
